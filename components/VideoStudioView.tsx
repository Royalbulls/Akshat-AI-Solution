...
import { FilmIcon, VideoCameraIcon, TrashIcon, PlusIcon, DownloadIcon, ShareIcon } from './Icons';
    ...
    const handleShare = async () => {
        ...
        try {
            ...
            const shareData = {
                ...
                text: `Generated by Akshat AI: "${prompt}"`,
                files: [file]
            };
            ...
            if (navigator.canShare && navigator.canShare(shareData)) {
                ...
                alert("Sharing not supported on this device. You can download the video instead.");
            }
        } catch (e) {
        ...
        <div className="h-full bg-gray-900 text-white p-4 md:p-8 overflow-y-auto animate-fade-in-slide-up">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                ...
                <div className="space-y-6 bg-gray-800/50 p-6 rounded-2xl border border-gray-700 shadow-xl">
                    ...
                    <div>
                        <label className="block text-sm font-bold text-gray-300 mb-2 uppercase tracking-wider">Start Frame (Image-to-Video)</label>
                            ...
                            >
                                {imageFile ? (
                                    ...
                                    <div className="flex flex-col items-center gap-2 text-gray-400">
                                        ...
                                        <span className="text-sm font-medium">Upload Start Frame (Optional)</span>
                                    </div>
                                )}
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            <button
                                ...
                                className={`flex-1 py-3 rounded-xl border-2 font-bold text-sm transition-all flex flex-col items-center gap-1 ${aspectRatio === '16:9' ? 'border-red-500 bg-red-500/10 text-red-400' : 'border-gray-700 bg-gray-900 text-gray-500 hover:border-gray-500'}`}
                            >
                                <span>Landscape (16:9)</span>
                                <span className="text-[10px] opacity-60 font-normal">Cinematic / YouTube</span>
                            </button>
                            <button
                                onClick={() => setAspectRatio('9:16')}
                                className={`flex-1 py-3 rounded-xl border-2 font-bold text-sm transition-all flex flex-col items-center gap-1 ${aspectRatio === '9:16' ? 'border-red-500 bg-red-500/10 text-red-400' : 'border-gray-700 bg-gray-900 text-gray-500 hover:border-gray-500'}`}
                            >
                                <span>Portrait (9:16)</span>
                                <span className="text-[10px] opacity-60 font-normal">Reels / Shorts / Mobile</span>
                            </button>
                        </div>
                    </div>
                        ...
                        {isGenerating ? (
                            ...
                            <div className="relative w-full h-full flex items-center justify-center bg-black">
                                ...
                                <div className="absolute bottom-4 right-4 flex gap-2">
                                    <button 
                                        onClick={handleShare}
                                        className="bg-gray-800/80 hover:bg-blue-600 text-white p-2 rounded-full backdrop-blur-sm transition-colors"
                                        title="Share Video"
                                    >
                                    ...
                                    <a 
                                        ...
                                        className="bg-gray-800/80 hover:bg-red-600 text-white p-2 rounded-full backdrop-blur-sm transition-colors"
